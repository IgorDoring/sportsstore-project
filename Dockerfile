...
ENV COOKIE_SECRET=${{sportsstore-project.COOKIE_SECRET}}
ENV GOOGLE_CLIENT_ID=${{sportsstore-project.GOOGLE_CLIENT_ID}}
ENV GOOGLE_CLIENT_SECRET=${{sportsstore-project.GOOGLE_CLIENT_SECRET}}
